...
CREATE TABLE `account_permission`  (
  ...
  `permission_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '权限代码, 只能英文, 如 user:list:show',
...
-- ----------------------------
INSERT INTO `account_permission` VALUES (1, '2019-11-17 21:38:55', '2019-11-17 21:38:55', 'show', '展示权限');
INSERT INTO `account_permission` VALUES (2, '2019-11-17 22:54:17', '2019-11-17 22:54:17', 'list', '列表权限');
...
-- ----------------------------
-- Records of account_permission_forbidden
-- ----------------------------
INSERT INTO `account_permission_forbidden` VALUES (1, '2019-11-17 22:54:38', '2019-11-17 22:54:42', 1, 1);
...
CREATE TABLE `account_role`  (
  ...
  `created_on` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_on` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `role_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '角色代码, 只能英文, 如 admin',
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '角色描述',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `role_name_index`(`role_name`) USING BTREE COMMENT '限制角色代码唯一'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of account_role
-- ----------------------------
INSERT INTO `account_role` VALUES (1, '2019-11-17 21:38:16', '2019-11-17 21:38:16', 'admin', '管理员');
...
-- ----------------------------
INSERT INTO `account_role_permission` VALUES (1, '2019-11-17 21:38:32', '2019-11-17 21:38:32', 1, 1);
...
-- ----------------------------
INSERT INTO `account_user` VALUES (1, '2019-11-17 13:48:55', '2019-11-17 13:48:55', 'gzl', 'gaozl', 'b396a66cd05a786c1e07f09a1815e2c5', 'salt1024', 1, NULL, '17611111111', '123@qq.com');
...
-- ----------------------------
-- Records of account_user_permission
-- ----------------------------
INSERT INTO `account_user_permission` VALUES (1, '2019-11-17 22:53:54', '2019-11-17 22:53:54', 1, 2);
...
-- ----------------------------
INSERT INTO `account_user_role` VALUES (1, '2019-11-17 22:16:46', '2019-11-17 22:16:46', 1, 1);
